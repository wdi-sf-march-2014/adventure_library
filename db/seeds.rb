...
adv = Adventure.create!(:title => "George's Test Adventure",
  :author => name)
adv.pages.create!(:name => "start",
  :text => "This is a test text adventure which is beginning right now! [[see the end|end]]")
adv.pages.create!(:name => "end",
  :text => "Wow that adventure was short!")